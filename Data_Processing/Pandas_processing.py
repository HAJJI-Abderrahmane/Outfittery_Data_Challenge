...
if __name__ == "__main__":
	...
	dfposts = pd.read_xml("../data/german.stackexchange.com/Posts.xml") ###Should install lxml for pandas to read xml 
	dfusers = pd.read_xml("../data/german.stackexchange.com/Users.xml")
